 ...
 * proposal.
 */
abstract contract GovernorPreventLateQuorum is GovernorProposals {
     ...
     */
    function proposalDeadline(uint256 proposalId) public view virtual override(GovernorProposals) returns (uint256) {
        return Math.max(GovernorProposals.proposalDeadline(proposalId), _extendedDeadlines[proposalId]);
    }
