...
contract ProposalLayerZeroRelayer is SimulationSetup {
    ...
    function test_SetRelayerSenderConfig() public {
        ...
        values[0] = 0;
        calldatas[0] = abi.encodeWithSelector(
            proposalSender().setConfig.selector, version, chainId, configType, abi.encode(blockConfirmation)
        );
    ...
    function test_SetRelayerSenderSendVersion() public {
        ...
        _shortcutProposal(1, description, targets, values, calldatas);
        assertEq(_lzEndPoint(1).getSendVersion(address(proposalSender())), defaultVersion);
        governor().execute(targets, values, calldatas, keccak256(bytes(description)));
        assertEq(_lzEndPoint(1).getSendVersion(address(proposalSender())), 1);
    }
    ...
    function test_RevertWhen_lzEndpointFail() public {
        ...
        vm.mockCallRevert(
            address(_lzEndPoint(1)), abi.encodeWithSelector(_lzEndPoint(1).send.selector), abi.encode("REVERT")
        );
        ...
        bytes memory payload =
            hex"";
        ...
        bytes memory execution = abi.encode(_getLZChainId(137), payload, adapterParams, 0.1 ether);
    ...
    function test_RevertWhen_NoFailTx() public {
        ...
        proposalSender().retryExecute(nonce, _getLZChainId(137), hex"", hex"", 1);
    }
    ...
    function test_RevertWhen_RetryExecuteWrongParams() public {
        ...
        proposalSender().retryExecute(1, _getLZChainId(137), hex"", hex"", 1);
    }
    ...
    function test_RetryExecuteSimple() public {
        ...
        proposalReceiver(destChain).lzReceive(
            _getLZChainId(srcChain), abi.encodePacked(proposalSender(), proposalReceiver(destChain)), 0, payload
        );

        vm.selectFork(forkIdentifier[destChain]);
        vm.warp(block.timestamp + timelock(destChain).getMinDelay() + 1);
        (address[] memory targets, uint256[] memory values, bytes[] memory calldatas) =
            filterChainSubCalls(destChain, p);
        assertEq(timelock(destChain).getMinDelay() != 100, true);
    ...
    function test_RetryExecuteMulti_OrderRetryOrderReceive() public {
        ...
        p2[0] = SubCall({
            ...
            value: 0,
            data: abi.encodeWithSelector(
                timelock(destChain).grantRole.selector, timelock(1).PROPOSER_ROLE(), address(alice)
                )
        });
        description = "Grant role on Optimism";
        bytes memory payload2 =
            hex"";
        ...
        hoax(address(_lzEndPoint(destChain)));
        proposalReceiver(destChain).lzReceive(
            _getLZChainId(1), abi.encodePacked(proposalSender(), proposalReceiver(destChain)), 0, payload1
        );
        ...
        {
            (address[] memory targets, uint256[] memory values, bytes[] memory calldatas) =
                filterChainSubCalls(destChain, p1);
            assertEq(timelock(destChain).getMinDelay() != 100, true);
            timelock(destChain).execute(targets[0], values[0], calldatas[0], bytes32(0), 0);
            assertEq(timelock(destChain).getMinDelay() == 100, true);
        }
        ...
        hoax(address(_lzEndPoint(destChain)));
        proposalReceiver(destChain).lzReceive(
            _getLZChainId(1), abi.encodePacked(proposalSender(), proposalReceiver(destChain)), 0, payload2
        );
        vm.warp(block.timestamp + oldDelay + 1);

        {
            (address[] memory targets, uint256[] memory values, bytes[] memory calldatas) =
                filterChainSubCalls(destChain, p2);
    ...
    function test_RetryExecuteBatch() public {
        ...
        bytes memory payload =
            hex"";
        bytes memory adapterParams = abi.encodePacked(uint16(1), uint256(300000));
        _dummyProposal(1, p, description, 0.1 ether, hex"");
        vm.clearMockedCalls();
        // We need to execute with an address to get the eth refund
        ...
        hoax(address(_lzEndPoint(destChain)));
        proposalReceiver(destChain).lzReceive(
            _getLZChainId(1), abi.encodePacked(proposalSender(), proposalReceiver(destChain)), 0, payload
        );
    ...
    function test_MainnetChangeAngleGovernorAndTimelock() public {
        ...
        TimelockControllerWithCounter timelock2 =
    ...
    function test_PolygonUpdateProposalReceiver() public {
        ...
        ProposalReceiver proposalReceiver2 = new ProposalReceiver(address(_lzEndPoint(137)));
        proposalReceiver2.setTrustedRemoteAddress(_getLZChainId(1), abi.encodePacked(_proposalSender));
        ...
        p[0] = SubCall({
            ...
            target: address(timelock(137)),
            value: 0,
            data: abi.encodeWithSelector(timelock(1).grantRole.selector, timelock(1).PROPOSER_ROLE(), newProposalReceiver)
        });
        p[1] = SubCall({
            chainId: 137,
            target: address(timelock(137)),
            value: 0,
            data: abi.encodeWithSelector(
                timelock(1).revokeRole.selector, timelock(1).PROPOSER_ROLE(), address(proposalReceiver(137))
                )
        });
        p[2] = SubCall({
            chainId: 1,
            ...
            value: 0,
            data: abi.encodeWithSelector(
                proposalSender().setTrustedRemoteAddress.selector, _getLZChainId(137), abi.encodePacked(proposalReceiver2)
                )
        });
    ...
    function test_RevertWhen_ReceiverCallFail() public {
        ...
        bytes memory payload =
            hex"";
        bytes memory adapterParams = abi.encodePacked(uint16(1), uint256(300000));
        bytes memory execution = abi.encode(_getLZChainId(destChain), payload, adapterParams, 0.1 ether);
        vm.mockCallRevert(
        ...
        assertEq(
            proposalReceiver(destChain).failedMessages(
                _getLZChainId(1), abi.encodePacked(proposalSender(), proposalReceiver(destChain)), 0
            ),
            keccak256(payload)
        );
    ...
    function test_RevertWhen_Receiver2ndCallFail() public {
        ...
        hoax(address(_lzEndPoint(destChain)));
        proposalReceiver(destChain).lzReceive(
            _getLZChainId(1), abi.encodePacked(proposalSender(), proposalReceiver(destChain)), 1, payload
        );
        assertEq(
            proposalReceiver(destChain).failedMessages(
                _getLZChainId(1), abi.encodePacked(proposalSender(), proposalReceiver(destChain)), 1
            ),
            keccak256(payload)
        );
    ...
    function test_RevertWhen_TimelockSidechainNotExecutor() public {
        ...
        bytes memory error = abi.encodeWithSelector(
            IAccessControl.AccessControlUnauthorizedAccount.selector, alice, timelock(1).EXECUTOR_ROLE()
        );
